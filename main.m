...
[aSp, aIp, aJp, aMp, aFp, aXp, aZp, mcP] = swp('p', nMC, pVec, sch, aDef, n0, xVec, zVec, zFix);
[aSa, aIa, aJa, aMa, aFa, aXa, aZa, mcA] = swp('a', nMC, pDef, aVec, sch, n0, xVec, zVec, zFix);

tp = io('tbl', pVec, 'Ps_dBm', aSp, aIp, aJp, aMp, aFp, aXp, aZp, sch);
ta = io('tbl', aVec, 'alpha', aSa, aIa, aJa, aMa, aFa, aXa, aZa, sch);

fp = plt('p', pVec, aSp, sch);
fa = plt('a', aVec, aSa, sch);

raw = {nMC,pDef,pVec,aVec,n0,zFix,xVec,zVec,aDef,aSp,aIp,aJp,aMp,aFp,aXp,aZp,mcP,aSa,aIa,aJa,aMa,aFa,aXa,aZa,mcA};
io('save', oDir, fP, fA, cP, cA, fp, fa, tp, ta, raw);
