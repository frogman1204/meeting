function met = solve_rsma_ambc_fixed(ch, Pt, sic_err, sigma2, rho_fixed, rate_threshold)
%SOLVE_RSMA_AMBC_FIXED RSMA-AmBC with fixed rho.

met = local_eval_rsma(ch, Pt, sic_err, sigma2, rho_fixed, rate_threshold, NaN);
